...
//
// intrusive_map_levels_storage_book_impl_data_t
//

template < typename Price_Level_Factory,
           template < typename V, typename R >
           class Order_Refs_Index >
struct intrusive_map_levels_storage_book_impl_data_t
{
...
struct intrusive_map_based_book_traits_t
{
    ...
    using sell_orders_table_t =
        book::map::intrusive::std_orders_table_t< impl_data_t,
...
JACOBI_GENERATE_BENCHMARKS_XXX_TYPES(
    intrusive_map_based_book_traits_t,
    intrusive_map_levels_storage_book_impl_data_t );
