...
struct std_map_levels_storage_book_impl_data_t
{
...
struct std_map_based_book_traits_t
{
    ...
    using sell_orders_table_t =
        book::map::std_map_orders_table_t< impl_data_t, book::trade_side::sell >;
    using buy_orders_table_t =
        book::map::std_map_orders_table_t< impl_data_t, book::trade_side::buy >;
};

JACOBI_GENERATE_BENCHMARKS_XXX_TYPES( std_map_based_book_traits_t,
                                      std_map_levels_storage_book_impl_data_t );
