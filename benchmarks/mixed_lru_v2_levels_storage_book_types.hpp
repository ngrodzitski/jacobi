...
//
// mixed_lru_v2_levels_storage_book_impl_data_t
//

template < typename Price_Level_Factory,
           template < typename V, typename R >
           class Order_Refs_Index >
struct mixed_lru_v2_levels_storage_book_impl_data_t
{
...
struct mixed_lru_based_book_traits_t
{
    ...
    using sell_orders_table_t =
        book::mixed::lru::v2::orders_table_t< impl_data_t,
                                              book::trade_side::sell >;
    using buy_orders_table_t =
        book::mixed::lru::v2::orders_table_t< impl_data_t, book::trade_side::buy >;
};
