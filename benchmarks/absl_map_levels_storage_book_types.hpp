...
{
//
// absl_map_levels_storage_book_impl_data_t
//

template < typename Price_Level_Factory,
           template < typename V, typename R >
           class Order_Refs_Index >
struct absl_map_levels_storage_book_impl_data_t
{
...
struct absl_map_based_book_traits_t
{
    // using bsn_counter_t = absl_bsn_counter_t;
    using bsn_counter_t = Book_Counter;
    using impl_data_t   = Impl_Data;
    using sell_orders_table_t =
        book::map::absl_map_orders_table_t< impl_data_t, book::trade_side::sell >;
    using buy_orders_table_t =
        book::map::absl_map_orders_table_t< impl_data_t, book::trade_side::buy >;
};

JACOBI_GENERATE_BENCHMARKS_XXX_TYPES( absl_map_based_book_traits_t,
                                      absl_map_levels_storage_book_impl_data_t );
