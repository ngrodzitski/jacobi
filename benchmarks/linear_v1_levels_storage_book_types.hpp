...
//
// linear_levels_storage_book_impl_data_t
//

template < typename Price_Level_Factory,
           template < typename V, typename R >
           class Order_Refs_Index >
struct linear_levels_storage_book_impl_data_t
{
...
//
// linear_based_book_traits_v1_t
//

template < typename Impl_Data, book::BSN_Counter_Concept Book_Counter >
struct linear_based_book_traits_v1_t
{
    ...
    using sell_orders_table_t =
        book::linear::v1::orders_table_t< impl_data_t, book::trade_side::sell >;
    using buy_orders_table_t =
        book::linear::v1::orders_table_t< impl_data_t, book::trade_side::buy >;
};

JACOBI_GENERATE_BENCHMARKS_XXX_TYPES( linear_based_book_traits_v1_t,
                                      linear_levels_storage_book_impl_data_t );
