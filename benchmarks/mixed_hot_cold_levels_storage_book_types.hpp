...
//
// mixed_hot_cold_levels_storage_book_impl_data_t
//

template < typename Price_Level_Factory,
           template < typename V, typename R >
           class Order_Refs_Index >
struct mixed_hot_cold_levels_storage_book_impl_data_t
{
...
//
// mixed_hot_cold_based_book_traits_t
//

template < typename Impl_Data, book::BSN_Counter_Concept Book_Counter >
struct mixed_hot_cold_based_book_traits_t
{
    ...
    using sell_orders_table_t =
        book::mixed::hot_cold::orders_table_t< impl_data_t,
                                               book::trade_side::sell >;
    using buy_orders_table_t =
        book::mixed::hot_cold::orders_table_t< impl_data_t,
                                               book::trade_side::buy >;
};

JACOBI_GENERATE_BENCHMARKS_XXX_TYPES(
    mixed_hot_cold_based_book_traits_t,
    mixed_hot_cold_levels_storage_book_impl_data_t );
